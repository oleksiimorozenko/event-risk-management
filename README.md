...
<details>
  ...
  <ol>
    ...
    <li>
      <a href="#solution-a-transit-delay-predictor">Solution: A Transit Delay Predictor</a>
      <ul>
    ...
    <li>
      <a href="#exploratory-analysis-and-data-cleaning">Exploratory Analysis and Data Cleaning</a>
      <ul>
    ...
    <li>
      ...
      <ul>
        <li><a href="#current-data-structure">Current data structure</a></li>
        <li><a href="#suggested-features-to-add">Suggested features to add</a></li>
        <li><a href="#data-preprocessing-steps">Data preprocessing steps</a></li>
        <li><a href="#selected-features">Selected Features</a></li>
      </ul>
    </li>
    <li>
      ...
      <ul>
        ...
        <li><a href="#third-try-final">Third try (final)</a></li>
        <li><a href="#selected-features">Selected Features</a></li>
      </ul>
    </li>
    <li><a href="#conclusion">Conclusion</a></li>
    <li><a href="#recommendations-for-ttc">Recommendations for TTC</a></li>
  </ol>
</details>
